...
(function () {
  ...
  const STRATEGY_NAV_ITEMS = [
    { id: "spx_water", asset: "S&P 500 Water", strategy: "SMA175 ±3% Band 1x/cash", group: "strategies", href: "spx_water.html" },
    ...
    { id: "dax", asset: "DAX", strategy: "SMA200 ±3% Band 1x/cash", group: "strategies", href: "dax_guarded.html#signalPage" },
    { id: "msci_em", asset: "MSCI EM", strategy: "SMA100 1x/cash", group: "strategies", href: "msci_em_guarded.html#signalPage" },
    { id: "msci_world", asset: "MSCI World", strategy: "SMA200 1x/cash", group: "strategies", href: "msci_world_guarded.html#signalPage" },
  ...
  function hrefForItem(item, loc = location) {
    ...
    let targetHash;
    if (item.id === "instruments" || item.id === "summary" || item.id === "spx" || item.id === "lab" || item.id === "price") {
